...
public class LivroDAO {
	...
	public void atualizar(Livro livro) {
		String sqlUpdate = "UPDATE livro SET nome=?, Autor=?, email=?, ano=? WHERE id=?";
		try (Connection conn = ConnectionFactory.obtemConexao();
